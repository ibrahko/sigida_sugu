...
class OrderService:
    ...
    def create_order(
        *,
        ...
        # Email de confirmation (async si Celery dispo, sinon synchrone)
        from apps.notifications.tasks import send_order_confirmation_email, dispatch
        dispatch(send_order_confirmation_email, order.id)
